...
const Product = ({ product, bg }: Props) => {
  ...
  return (
    <div className="w-full relative group border-[1px] border-grey hover:shadow-lg duration-200 shadow-gray-500 rounded-md overflow-hidden group ">
      <div className="w-full h-80 flex items-center justify-center bg-white overflow-hidden">
        <div className={`relative ${bg}`}>
          ...
          <div className="absolute bottom-0 flex items-center gap-4 justify-center translate-y-[250%] group-hover:-translate-y-2 translate-transform duration-300">
            <button
              onClick={() => {
      ...
      <div className="max-w-80 py-6 flex flex-col gap-1 px-4">
        <div className="flex items-center justify-between">
          <h2 className="text-medium text-primeColor font-bold">
